        ...
        <div class="row">
            <form method="POST" action="index.php?page=searchOffre">
                ...
                <div class="col-lg-2">
                    <div class="form">
                        <div class="form-group">
                            <input type="text" name="TypeContrat" class="input-lg form-control" placeholder="Saisir le type de contrat">
                        </div>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="form">
                        <div class="form-group">
                            <input type="text" name="lieu" class="input-lg form-control" placeholder="Saisir le domaine">
                        </div>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="form">
                        <div class="form-group">
                            <input type="text" name="lieu" class="input-lg form-control" placeholder="Saisir le secteur">
                        </div>
                    </div>
                </div>
                <div class="col-lg-2">
    ...
    <section class="four">
        <div class="row">
            <div class="col-sm-offset-4 col-sm-5">
                <h3 style="text-transform: uppercase;"><span class="glyphicon glyphicon-alarm"></span> Toutes les offres publiées recemment</h3> </br></br>
            </div>
