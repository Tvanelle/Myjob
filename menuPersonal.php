                ...
                <div class="col-sm-offset-3 col-sm-7">
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li style="border: 2px solid rgb(0,226,102);border-radius: 5px;"><a href="index.php?page=deconnectPage&IdRecrut=<?= $IdRecrut ?>" class="btn btn-inverse" id="btn-creer"><span class="glyphicon glyphicon-user"></span> Se deconnecter</a>
